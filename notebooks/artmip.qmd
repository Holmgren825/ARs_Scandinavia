...
- Lots of data, 6 hourly needed?
- Possible library `xeofs`, but memory blows up
- Plain SVD works
- Next step is to figure out MCA or a join PCA
    - But not sure what these would give yet.
